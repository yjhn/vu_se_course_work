...
const EVOLUTION_GENERATION_COUNT: u32 = 50;
...
const SOLUTION_STRATEGY: SolutionStrategy = SolutionStrategy::CgaTwoOpt;
...
fn main() {
    ...
    let mut solver =
        TspSolver::<MainRng>::from_file(path.clone(), SOLUTION_STRATEGY, random_seed, world);
